---
title: Site Profile — {dominio}
dominio: {dominio}
generado: {YYYY-MM-DD}
actualizado: {YYYY-MM-DD}
tags:
  - seo/site-profile
  - cliente/{dominio-slug}
  - industria/{industria-slug}
estado: validado
---

# Site Profile: {dominio}
...
*Páginas con impresiones sostenidas pero CTR muy bajo y posición > 10 — señal de contenido desactualizado o superado por competidores.*
...
> [!bug] Issues detectados — OnPage Score {score}/100
> - **CMS**: {cms}
> - **SSL**: {estado}
> - `{issue}` — {descripción}
> - `{issue}` — {descripción}
